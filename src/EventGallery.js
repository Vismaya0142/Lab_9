...
const EventGallery = ({ userDetails }) => {
    ...
    const UNSPLASH_ACCESS_KEY = '_mzC9b3I2KHJimtrM7rnDIpHuKC6qzlc0YPgxpugUMU'; // Replace with your actual Unsplash access key
    ...
    return (
        <div className="event-gallery">
            ...
            <h3>Your Password: {userDetails.password}</h3>
